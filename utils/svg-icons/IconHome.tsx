// icon:home-fill-24 | Octicons https://primer.style/octicons/ | Github Primer
import * as React from "react";

function IconHomeFillTwentyFour(props: React.SVGProps<SVGSVGElement>) {
  return (
...
export default IconHomeFillTwentyFour;
